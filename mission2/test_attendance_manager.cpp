...
extern void runAttendanceManager(string attendanceListFilePath);
...
TEST_F(AttendanceManagerFixture, ALL_TC1) {

	std::ostringstream oss;
	auto oldStreamBuf = std::cout.rdbuf();
...
TEST_F(AttendanceManagerFixture, InvalidFilePath) {
	EXPECT_THROW(runAttendanceManager("temp.txt"), std::exception);
}
